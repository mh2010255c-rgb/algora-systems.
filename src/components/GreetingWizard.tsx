...
export default function GreetingWizard({ onClose, onSelectTrial }: GreetingWizardProps) {
  ...
  return (
    <div id="greeting-wizard" className="bg-gradient-to-br from-blue-950/95 via-blue-950/95 to-slate-50/98 backdrop-blur-md flex items-center justify-center p-4 z-50 overflow-y-auto rounded-3xl border border-blue-500/20 shadow-2xl">
      <div className="max-w-xl w-full text-center text-slate-900 py-8 px-6 relative">
        <div className="absolute top-2 left-2 flex gap-1">
          {[1, 2, 3].map((s) => (
            <div
              key={s}
              className={`w-3 h-1.5 rounded-full transition-all duration-300 ${
                s <= step ? "bg-blue-500 w-6" : "bg-slate-700"
              }`}
            />
          ))}
        </div>
        ...
        <AnimatePresence mode="wait">
          {step === 1 && (
            <motion.div
              ...
              className="space-y-6"
            >
              <div className="inline-flex p-3.5 bg-blue-500/15 rounded-full border border-blue-500/30 text-blue-600 mb-2">
                <span className="text-3xl animate-bounce">👋</span>
              </div>
              <h2 className="text-2xl md:text-3xl font-extrabold tracking-tight">
                مرحباً بك في <span className="text-blue-600">Algora Systems</span>
              </h2>
              ...
              <div className="grid grid-cols-1 gap-3 pt-4">
                <button
                  ...
                  className="group flex items-center justify-between p-4 bg-slate-50/60 hover:bg-blue-900/30 border border-slate-200 hover:border-blue-500/50 rounded-xl text-right transition-all duration-200"
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h4 className="font-bold text-slate-900 text-sm md:text-base">نعم، أملك محل هواتف وصيانة قائم</h4>
                      <p className="text-slate-600 text-xs">أريد نظاماً ينظم مبيعاتي، مخزوني وعمليات الصيانة.</p>
                    </div>
                  </div>
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h4 className="font-bold text-slate-900 text-sm md:text-base">أخطط لفتح محل هواتف قريباً</h4>
                      <p className="text-slate-600 text-xs">أبحث عن نظام متكامل لأبدأ مشروعي باحترافية تامة.</p>
                    </div>
                  </div>
                  <ArrowLeft className="w-5 h-5 text-slate-500 group-hover:text-blue-600 group-hover:-translate-x-1 transition-transform" />
                </button>
          ...
          {step === 2 && (
            ...
            >
              <h2 className="text-xl md:text-2xl font-bold">
                ما هي <span className="text-blue-600">أكبر مشكلة</span> تعاني منها في تسيير محلك حالياً؟
              </h2>
                ...
                {painPoints.map((pain) => {
                  ...
                  return (
                    <button
                      ...
                      className="w-full text-right p-4 bg-slate-50/60 hover:bg-blue-900/30 border border-slate-200 hover:border-blue-500/40 rounded-xl flex items-start gap-3.5 transition-all duration-200 group"
                    >
                      <div className="p-2.5 bg-blue-500/10 rounded-lg text-blue-600 group-hover:bg-blue-500/20 shrink-0 mt-0.5">
                        <IconComp className="w-5 h-5" />
                      </div>
                      <div className="grow">
                        <h4 className="font-bold text-slate-900 text-sm md:text-base group-hover:text-blue-500 transition-colors">
                          {pain.title}
                        </h4>
          ...
          {step === 3 && (
            <motion.div
              ...
              className="space-y-6"
            >
              <div className="inline-flex p-4 bg-orange-500/10 rounded-full border border-emerald-500/20 text-emerald-400 mb-1 animate-pulse">
              ...
              <div className="bg-white/80 border border-slate-200 rounded-xl p-5 text-right space-y-3 my-4">
                <h3 className="font-bold text-blue-600 text-sm md:text-base">
                  💡 تخصيص ذكي لمحلك:
                </h3>
              ...
              <div className="flex flex-col sm:flex-row gap-3 pt-2">
                <button
                  ...
                  className="grow py-3 px-5 bg-gradient-to-l from-blue-600 to-blue-500 hover:from-blue-500 hover:to-blue-400 text-white font-bold rounded-xl shadow-lg shadow-blue-900/10 transition-all duration-200 text-sm md:text-base flex items-center justify-center gap-2"
                >
                ...
                <button
                  onClick={onClose}
                  className="py-3 px-5 bg-slate-100 hover:bg-slate-200 border border-slate-200 text-slate-800 font-medium rounded-xl transition-all duration-200 text-sm md:text-base"
                >

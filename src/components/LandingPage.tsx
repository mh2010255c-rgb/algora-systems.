        ...
        <div className="max-w-7xl mx-auto px-2 md:px-6 space-y-8">
          <div className="flex justify-center mt-2 mb-8 relative z-10">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group relative flex items-center justify-center gap-3 px-8 py-3.5 bg-gradient-to-r from-[#25D366] to-[#1DA851] text-white rounded-2xl shadow-lg shadow-[#25D366]/30 hover:shadow-[#25D366]/60 hover:-translate-y-1 hover:scale-105 transition-all duration-300 font-bold overflow-hidden border border-[#25D366]/50"
            >
              <div className="absolute inset-0 bg-white/20 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity blur-md"></div>
              
              <svg className="w-6 h-6 fill-current relative z-10 animate-bounce group-hover:animate-none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">

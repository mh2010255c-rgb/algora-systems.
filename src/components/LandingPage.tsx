      ...
      <section id="download-trial-section" className="space-y-12 py-12 border-t border-slate-900/80 relative">
        ...
        <div className="max-w-xl mx-auto bg-slate-950/30 border border-slate-900 p-4 rounded-xl text-center text-xs text-slate-400 space-y-1 relative z-10">
          ...
          <p className="leading-relaxed">
            لا تقلق، فريق الدعم الفني الجزائري في خدمتك! اتصل بنا عبر الهاتف <a href="https://wa.me/213553361047" target="_blank" rel="noopener noreferrer" className="font-mono font-bold text-purple-400 text-[13px] inline-block hover:underline cursor-pointer" dir="ltr">+213 553 36 10 47</a> أو تواصل معنا عبر واتساب، وسيتصل بك أحد مهندسينا لتثبيت وتجهيز البرنامج على حاسوبك مجانًا بالكامل عبر <span className="font-bold text-indigo-400">AnyDesk</span>.
          </p>
        </div>
      </section>

...
export default function TrialsTab({
  ...
  const translateProg = (val?: string) => {
    ...
    if (val === "annual") return "الباقة السنوية (12,000 دج) ✨";
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-3">
          ...
          <div className="space-y-1">
            ...
            >
              ...
              <option value="pc">باقة لوجيسيال حاسوب فقط (10K) 💻</option>
              <option value="mobile">باقة تطبيق هاتف فقط (8K) 📱</option>
              <option value="both">باقة تطبيق هاتف مع حاسوب معاً (12K) ✨</option>
            </select>
          </div>
